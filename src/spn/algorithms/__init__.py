...
from spn.structure.leaves.spmnLeaves.Inference import add_utility_inference_support, \
                                                      add_latent_interface_inference_support
from spn.structure.leaves.spmnLeaves.MEU import add_utility_mpe_support, add_latent_interface_mpe_support
...
add_latent_interface_inference_support()
add_latent_interface_mpe_support()