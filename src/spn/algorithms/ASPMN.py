...
class Anytime_SPMN:
	...
	def learn_aspmn(self, train, test, k=None):
		...
		original_stats = {
			...
			'Test_Strep': {"ll" : -0.9130071749277912, "meu" : 54.9416526618876, 'nodes' : 130, 'reward':54.93213179999943, 'dev':0},
			'LungCancer_Staging': {"ll" : -1.1489156814245234, "meu" : 3.138664586296027, 'nodes' : 312, 'reward':3.1384699999999968, 'dev':0},
			'HIV_Screening': {"ll" : -0.6276399171508842, "meu" : 42.582734183407034, 'nodes' : 112, 'reward':42.44111199999939, 'dev':0.23971563294033557},
			'Computer_Diagnostician': {"ll" : -0.8920749045689644, "meu" : 244.85700000000003, 'nodes' : 47, 'reward':244.61749999999998, 'dev':1.120870197658941},
			'Powerplant_Airpollution': {"ll" : -1.0796486063753, "meu" : -2756263.244346315, 'nodes' : 46, 'reward':-2775600.0, 'dev':0}
		}
